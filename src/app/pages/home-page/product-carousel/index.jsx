...
function ProductCarousel(props) {
    ...
    return (
        <Carousel draggable slidesPerRow={3} speed={2000} autoplay={true} autoplaySpeed={10000} pauseOnHover={false} dots={false}>
                ...
                <div key={product["id"]}>
                    <Row>
                        <Col span={22} push={1}>
                            ...
                            >
                                <Col span={10} onClick={() => handleViewProduct(product)}>
                                    {product["images"].length > 0 ? (
                                        <Image
                                            alt="Product image"
                                            className="product-card__img"
                                            src={`${product["images"][0]["url"]}/tr:w-300,h-300`}
                                        />
                                    ) : (
